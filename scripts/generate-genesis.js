...
program.option('-p, --presaleOwner <presale-owner-address>', 'presale owner address', '0x...');
...
Promise.all([
  ...
  readByteCode('presale', 'out/L2PPresale.sol/L2PPresale.json')
]).then((result) => {
  const data = {
    ...
    presaleOwner: program.presaleOwner.slice(2).toLowerCase(),
  };
