...
contract L2PValidatorSet is IL2PValidatorSet, System, IParamSubscriber {
    ...
    function _exitMaintenance(
        ...
        uint256 maintainedBlocks = block.number.sub(validatorExtraSet[index].enterMaintenanceHeight);
        uint256 slashCount = maintainedBlocks.div(miningValidatorCount).div(maintainSlashScale);
